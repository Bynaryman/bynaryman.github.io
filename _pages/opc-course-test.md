...
Open the RevealJS version directly in the site:

[View the HTML slide deck]({{ '/assets/courses/opc/cm3/cm3.html' | relative_url }}){: .btn .btn-primary }
...
The current test is generated from the local Quarto CM3 deck and copied here as static website assets.
